...
public class DriveOptions {
		...
		do {
			try {
				...
				case 1:
					...
					break;
				case 2:
					DriveOptions.handleFileMenuOptions();
					break;
				case 3:
	...
	public static void handleFileMenuOptions() {
		...
		do {
			try {
				Optionlist.displayFileMenuOptions();
				...
				case 1:
					...
					System.out.println("Enter the file name  it should be add to  \"main\" folder");
				...
				case 2:
					// File/Folder delete
					System.out.println("Enter the name that should be  deleted from \"main\" folder");
					...
					String deletionPrompt = "\nSelect index of which file to delete?"
							+ "\n(Enter # if you want to delete all elements)";
